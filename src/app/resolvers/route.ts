...
export const resolvers = {
  ...
  Mutation: {
    addUser: async (parent: {}, { name, email, password }: { name: String, email: String, password: String }) => {
      try {
    ...
    doLogin: async (parent: {}, { email, password }: { email: String, password: string }, context: Context) => {
